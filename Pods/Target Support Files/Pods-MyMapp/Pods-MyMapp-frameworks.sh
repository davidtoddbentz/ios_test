...
if [[ "$CONFIGURATION" == "DEV-Developer" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/NMessenger/NMessenger.framework"
...
if [[ "$CONFIGURATION" == "LIVE-Developer" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/Alamofire/Alamofire.framework"
  install_framework "$BUILT_PRODUCTS_DIR/ApiAI/ApiAI.framework"
  install_framework "$BUILT_PRODUCTS_DIR/AsyncDisplayKit/AsyncDisplayKit.framework"
  install_framework "$BUILT_PRODUCTS_DIR/Bolts/Bolts.framework"
...
if [[ "$CONFIGURATION" == "LIVE-ENT" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/Alamofire/Alamofire.framework"
  install_framework "$BUILT_PRODUCTS_DIR/ApiAI/ApiAI.framework"
  install_framework "$BUILT_PRODUCTS_DIR/AsyncDisplayKit/AsyncDisplayKit.framework"
  install_framework "$BUILT_PRODUCTS_DIR/Bolts/Bolts.framework"
...
if [[ "$CONFIGURATION" == "LIVE-STORE" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/Alamofire/Alamofire.framework"
  install_framework "$BUILT_PRODUCTS_DIR/ApiAI/ApiAI.framework"
  install_framework "$BUILT_PRODUCTS_DIR/AsyncDisplayKit/AsyncDisplayKit.framework"
  install_framework "$BUILT_PRODUCTS_DIR/Bolts/Bolts.framework"
